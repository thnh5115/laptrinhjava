...
import { JourneyHistoryTable } from "@/components/ev-owner/journey-history-table"
    ...
    <DashboardLayout navigation={navigation}>
      <div>
        <div className="mb-6">
          ...
          <p className="text-muted-foreground">View all your submitted EV journeys and their verification status</p>
        </div>
        <JourneyHistoryTable />
      </div>
    </DashboardLayout>
