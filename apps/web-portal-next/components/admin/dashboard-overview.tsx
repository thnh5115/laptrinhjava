...
import { mockUsers, mockJourneys, mockTransactions } from "@/lib/mock-data"
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center justify-between border-b pb-3">
                <div className="space-y-1">
                  ...
                  <p className="text-xs text-muted-foreground">18.0 tCO2 sold for $432</p>
                </div>
              ...
              <div className="flex items-center justify-between">
                <div className="space-y-1">
                  ...
                  <p className="text-xs text-muted-foreground">CVA approved 15.2 tCO2</p>
                </div>
