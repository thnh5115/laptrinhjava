...
import { mockJourneys, mockCredits } from "@/lib/mock-data"
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">Per credit (tCO2)</p>
          </CardContent>
        </Card>
      </div>
              ...
              {userJourneys.slice(0, 3).map((journey) => (
                <div key={journey.id} className="flex items-center justify-between border-b pb-3 last:border-0">
                  ...
                  <div className="text-right">
                    <p className="text-sm font-medium">{journey.creditsGenerated.toFixed(1)} tCO2</p>
                    <p
                      className={`text-xs ${
