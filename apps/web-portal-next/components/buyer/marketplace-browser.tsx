...
import { mockCredits, mockJourneys, mockUsers } from "@/lib/mock-data"
            ...
            <Card key={credit.id} className="flex flex-col">
              <CardHeader>
                <div className="flex items-start justify-between">
                  <div>
                    <CardTitle className="text-lg">{credit.amount.toFixed(1)} tCO2</CardTitle>
                      ...
                      <div className="space-y-4 py-4">
                        <div className="p-4 bg-muted rounded-lg space-y-2">
                          <div className="flex justify-between">
                            ...
                            <span className="font-medium">{credit.amount.toFixed(1)} tCO2</span>
                          </div>
                          <div className="flex justify-between">
                        ...
                        <div className="space-y-2">
                          <Label htmlFor="amount">Amount to Purchase (tCO2)</Label>
                          <Input
                            id="amount"
                            type="number"
                            step="0.1"
