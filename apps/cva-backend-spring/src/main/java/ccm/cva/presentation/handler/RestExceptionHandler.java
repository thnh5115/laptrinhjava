...
public class RestExceptionHandler {
    ...
    @ExceptionHandler(DuplicateTripVerificationRequestException.class)
    public ResponseEntity<ApiError> handleDuplicateTrip(DuplicateTripVerificationRequestException ex, HttpServletRequest request) {
        ApiError error = ApiError.of(
                HttpStatus.CONFLICT.value(),
                HttpStatus.CONFLICT.getReasonPhrase(),
                ex.getMessage(),
    ...
    @ExceptionHandler(InvalidTripMetricsException.class)
    public ResponseEntity<ApiError> handleInvalidTripMetrics(InvalidTripMetricsException ex, HttpServletRequest request) {
        ApiError error = ApiError.of(
