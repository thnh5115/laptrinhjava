...
import { mockDisputes, mockUsers, mockTransactions } from "../../../apps/web-portal-next/lib/mock-data"
          ...
          {transaction && (
            <div className="p-4 border rounded-lg bg-muted/50">
              ...
              <div className="grid grid-cols-2 gap-2 text-sm">
                <div>
                  <span className="text-muted-foreground">Amount:</span> {transaction.amount} tCO₂
                </div>
                <div>
