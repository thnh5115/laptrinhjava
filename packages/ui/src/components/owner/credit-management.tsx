...
import { mockCredits, mockJourneys } from "../../../apps/web-portal-next/lib/mock-data"
    ...
    <div className="space-y-6">
      <div className="grid gap-4 md:grid-cols-3">
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">
              {availableCredits.reduce((sum, c) => sum + c.amount, 0).toFixed(1)} tCO₂
            </div>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">
              {soldCredits.reduce((sum, c) => sum + c.amount, 0).toFixed(1)} tCO₂
            </div>
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">Per tCO₂</p>
          </CardContent>
        </Card>
      </div>
                ...
                return (
                  <div key={credit.id} className="flex items-center justify-between border rounded-lg p-4">
                    <div className="space-y-1">
                      <p className="font-medium">{credit.amount.toFixed(1)} tCO₂</p>
                      {journey && (
                    ...
                    <div className="text-right">
                      <p className="text-lg font-bold text-emerald-600">${credit.pricePerCredit}/tCO₂</p>
          ...
          <Dialog>
            ...
            <DialogContent>
              <DialogHeader>
                ...
                <DialogDescription>Set your price per credit (tCO₂) to list on the marketplace</DialogDescription>
              </DialogHeader>
              <div className="space-y-4 py-4">
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    placeholder="25.00"
                  />
                  <p className="text-xs text-muted-foreground">Market average: $25.00 per tCO₂</p>
                </div>
                <div className="p-4 bg-muted rounded-lg">
                  <p className="text-sm font-medium mb-2">Available to List:</p>
                  <p className="text-2xl font-bold text-emerald-600">15.2 tCO₂</p>
